    ...
    <div className="">
      ...
      <main className="mx-auto flex flex-col max-w-7xl items-center justify-between p-6 lg:px-8">
        <div className="w-full flex justify-between mb-5">
          <h1 className="w-full mb-4.5 scroll-m-20 text-left text-4xl font-extrabold tracking-tight text-balance">
            Produtos
          </h1>
          <div className={`
            flex cursor-pointer shrink-0 px-3 py-2 mr-6 text-sm font-bold items-center
            text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 
